...
class HtmlIntermediateQuizState extends State<HtmlIntermediateQuiz> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question':
          '1. Which HTML element is used to define a navigation section?',
    ...
    {
      'question':
          '4. Which HTML5 element is used to group related form elements?',
    ...
    {
      'question':
          '8. Which HTML5 element is used to define a footer for a document or section?',
